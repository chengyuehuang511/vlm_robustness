...
from data.imagenet_hierarchy import HierarchyInterface, ImagenetHierarchy
from data.interface_metadata import ClsMetadataInterface
from metrics.clip_match import compute_class_embeddings_given_embedder, EmbeddingAccuracy
from metrics.clip_match_synonyms import EmbeddingSynonymAccuracy
from metrics.syn_logits import reduce_synonym_logits_over_classes
from utils_folder.paths import get_ovqa_annotations_dir
from utils_folder.cut_sentence import cut_too_long_text
from metrics.metrics_utils import EmbeddingsPackageConst, SentenceEmbedderInterface
