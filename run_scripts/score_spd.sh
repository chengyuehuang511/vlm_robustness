#!/bin/bash
#SBATCH --job-name=calcspd
#SBATCH --output=calclspd.out
#SBATCH --error=calcspd.err
...
srun -u python -m torch.distributed.run --nproc_per_node=1 /nethome/bmaneech3/flash/vlm_robustness/ood_test/contextual_ood/measure.py --ft_method "spd"  --concept_list "$concept_list_json"