#!/bin/bash
#SBATCH --job-name=testvqacp
#SBATCH --output=testvqacp.out
#SBATCH --error=testvqacp.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/vqacp_test.yaml
