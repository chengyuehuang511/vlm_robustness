#!/bin/bash
#SBATCH --job-name=testivvqa
#SBATCH --output=testivvqa.out
#SBATCH --error=testivvqa.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/iv-vqa_test.yaml
