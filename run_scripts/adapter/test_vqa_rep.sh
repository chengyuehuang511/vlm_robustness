#!/bin/bash
#SBATCH --job-name=testvqarep
#SBATCH --output=testvqarep.out
#SBATCH --error=testvqarep.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/vqa_rep_test.yaml
