#!/bin/bash
#SBATCH --job-name=testvizwiz
#SBATCH --output=testvizwiz.out
#SBATCH --error=testvizwiz.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/vizwiz_test.yaml
