#!/bin/bash
#SBATCH --job-name=testadvqa
#SBATCH --output=testadvqa.out
#SBATCH --error=testadvqa.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/advqa_test.yaml
