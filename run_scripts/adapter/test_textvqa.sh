#!/bin/bash
#SBATCH --job-name=testtextvqa
#SBATCH --output=testtextvqa.out
#SBATCH --error=testtextvqa.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/textvqa_test.yaml
