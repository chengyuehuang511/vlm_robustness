#!/bin/bash
#SBATCH --job-name=testPAftvqav2 
#SBATCH --output=testPAftvqav2.out
#SBATCH --error=testPAftvqav2.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/parallel_adapter/vqav2_train_1.yaml
