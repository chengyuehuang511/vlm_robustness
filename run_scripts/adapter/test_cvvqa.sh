#!/bin/bash
#SBATCH --job-name=testcvvqa
#SBATCH --output=testcvvqa.out
#SBATCH --error=testcvvqa.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/cv-vqa_test.yaml
