...
srun -u /coc/testnvme/chuang475/miniconda3/envs/lavis_same/bin/python -m torch.distributed.run --nproc_per_node=4 --rdzv-endpoint=$MASTER_ADDR:$MASTER_PORT evaluate.py --cfg-path configs/llava/vizwiz_test.yaml