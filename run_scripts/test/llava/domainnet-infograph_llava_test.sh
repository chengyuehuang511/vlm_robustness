...
#SBATCH --qos="short"
#SBATCH -x nestor,uniblab,robby,conroy
...
srun -u /coc/testnvme/chuang475/miniconda3/envs/lavis_same/bin/python -m torch.distributed.run --nproc_per_node=4 evaluate.py --cfg-path configs/llava/domainnet-infograph_test.yaml
