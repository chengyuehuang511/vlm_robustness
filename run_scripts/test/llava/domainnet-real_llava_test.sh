...
srun -u /coc/testnvme/chuang475/miniconda3/envs/lavis_same/bin/python -m torch.distributed.run --nproc_per_node=2 evaluate.py --cfg-path configs/llava/domainnet-real_test.yaml
