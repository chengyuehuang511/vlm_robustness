...
srun -u /coc/testnvme/chuang475/miniconda3/envs/lavis/bin/python -m torch.distributed.run --nproc_per_node=8 evaluate.py --cfg-path configs/paligemma/domainnet-clipart_test.yaml
