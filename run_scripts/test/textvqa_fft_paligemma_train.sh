#!/bin/bash
#SBATCH --job-name=text_vqa_fft
#SBATCH --output=text_vqa_fft.out
#SBATCH --error=text_vqa_fft.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 train.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/paligemma/textvqa_fft.yaml
