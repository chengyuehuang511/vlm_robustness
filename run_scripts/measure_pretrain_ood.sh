#!/bin/bash
#SBATCH --job-name=pt_ood
#SBATCH --output=pt_ood.out
#SBATCH --error=pt_ood.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 /nethome/bmaneech3/flash/vlm_robustness/ood_test/contextual_ood/pretrain_measure.py