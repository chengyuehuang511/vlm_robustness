#!/bin/bash
#SBATCH --job-name=calclora
#SBATCH --output=calclora.out
#SBATCH --error=calclora.err
...
srun -u python -m torch.distributed.run --nproc_per_node=1 /nethome/bmaneech3/flash/vlm_robustness/ood_test/contextual_ood/measure.py --ft_method "lora"  --concept_list "$concept_list_json"