...
srun -u /coc/testnvme/chuang475/miniconda3/envs/lavis_same/bin/python -m torch.distributed.run --nproc_per_node=8 train.py --cfg-path configs/paligemma/gqa_train.yaml