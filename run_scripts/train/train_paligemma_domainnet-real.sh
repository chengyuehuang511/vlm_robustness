...
srun -u /nethome/chuang475/flash/miniconda3/envs/lavis/bin/python -m torch.distributed.run --nproc_per_node=8 train.py --cfg-path configs/paligemma/domainnet-real_train.yaml