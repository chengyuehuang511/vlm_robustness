#!/bin/bash
#SBATCH --job-name=vqa_vs_blip2
#SBATCH --output=vqa_vs_blip2.out
#SBATCH --error=vqa_vs_blip2.err
...
srun -u python -m torch.distributed.run --nproc_per_node=8 train.py --cfg-path /nethome/bmaneech3/flash/vlm_robustness/configs/blip2/vqavs_train_opt.yaml