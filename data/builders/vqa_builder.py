...
class COCOADVQABuilder(BaseDatasetBuilder): 
    ...
    DATASET_CONFIG_DICT = { 
        "default": "/nethome/chuang475/flash/projects/vlm_robustness/data/configs/advqa.yaml"
    }
...
class TextVQABuilder(BaseDatasetBuilder): 
    ...
    DATASET_CONFIG_DICT = { 
        "default": "/nethome/chuang475/flash/projects/vlm_robustness/data/configs/textvqa.yaml"
    }
...
class VizWizBuilder(BaseDatasetBuilder): 
    ...
    DATASET_CONFIG_DICT = { 
        "default": "/nethome/chuang475/flash/projects/vlm_robustness/data/configs/vizwiz.yaml"
    }
...
class COCOOKVQABuilder(BaseDatasetBuilder): 
    ...
    DATASET_CONFIG_DICT = { 
        "default": "/nethome/chuang475/flash/projects/vlm_robustness/data/configs/ok-vqa.yaml"
    }