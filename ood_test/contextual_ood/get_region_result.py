...
def process_qid_2_score(emb_tensor, split, concept) : 
    ...
    store_path = f"/coc/pskynet4/bmaneech3/vlm_robustness/result_output/contextual_ood/region_samples/pt_{split}_{concept}_qid_score.json"
...
for dataset, res_path in  dataset_to_res_path.items(): 
    ...
    metric_path = f"/coc/pskynet4/bmaneech3/vlm_robustness/result_output/contextual_ood/region_samples/result/{dataset}_overall.txt"
    # output_dir = f"/coc/pskynet4/bmaneech3/vlm_robustness/result_output/contextual_ood/region_samples/result/{dataset}_output.txt"
    ...
    incorrect_sample_path = f"/coc/pskynet4/bmaneech3/vlm_robustness/result_output/contextual_ood/region_samples/result/{dataset}_{concept}_incorrect_sample.json"
    ...
    incorrect_sample_path = f"/coc/pskynet4/bmaneech3/vlm_robustness/result_output/contextual_ood/region_samples/result/{dataset}_{concept}_incorrect_sample.json"
    if concept == "joint" :
        incorrect_sample_path = f"/coc/pskynet4/bmaneech3/vlm_robustness/result_output/contextual_ood/region_samples/result/{dataset}_incorrect_sample.json"
    incorrect_samples = json.load(open(incorrect_sample_path, 'r'))
    ...
    plt.savefig(f"/coc/testnvme/chuang475/projects/vlm_robustness/ood_test/contextual_ood/region_samples/result/{dataset}_{concept}_fail_distrib.png")
    plt.clf()
    ...
    plt.savefig(f"/coc/testnvme/chuang475/projects/vlm_robustness/ood_test/contextual_ood/region_samples/result/{dataset}_{concept}_incorrect_perc.png")
    plt.close()
