...
for name in "test_paligemma_imagenet1k" "test_paligemma_imagenet-2" "test_paligemma_imagenet-r" "test_paligemma_imagenet-a" "test_paligemma_imagenet-s" 
...
do
    ...
    output_dir="output/imagenet/spd_wise/${job_name}"
    mkdir -p "$output_dir"
