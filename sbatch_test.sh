...
for name in "test_paligemma_vqa_rep" "test_paligemma_ok-vqa" "test_paligemma_vizwiz" "test_paligemma_textvqa" "test_paligemma_advqa" "test_paligemma_cv-vqa" "test_paligemma_iv-vqa"
...
do
    ...
    output_dir="tpcgrad_share6/output/vqa_ft/spcg_1e-3_mu0.5/${job_name}"
    mkdir -p "$output_dir"
