...
for name in "domainnet-clipart_paligemma_test" "domainnet-infograph_paligemma_test" "domainnet-painting_paligemma_test" "domainnet-quickdraw_paligemma_test" "domainnet-real_paligemma_test" "domainnet-sketch_paligemma_test"
...
do
    ...
    output_dir="tpcgrad_share6/output/domainnet_ft/tpcgrad_normafter_1e-3_1e-4_mu1e-1/${job_name}"
    mkdir -p "$output_dir"
